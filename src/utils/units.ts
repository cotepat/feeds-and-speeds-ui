...
export const units: Record<string, Unit> = {
  ...
  cutterYoungsModulus: { formatting: fixedDigits(3), unit: "" },
  ...
  materialRemovalRate: { formatting: fixedDigits(3), unit: "in^3/min" },
  powerUsage: { formatting: fixedDigits(3), unit: "kW" },
  torque: { formatting: fixedDigits(3), unit: "in*lbf" },
